...
function WarpdriveObject(warpdriveInstance) {
    ...
    function serializeRenderFunctions() {
        self.serialized = {
            redraw: self.redraw.toString(),
            specificRedraw: self.specificRedraw.toString(),
            drawSelection: self.drawSelection.toString()
        }
    }
    ...
    this.serializeRenderFunctions = serializeRenderFunctions;
