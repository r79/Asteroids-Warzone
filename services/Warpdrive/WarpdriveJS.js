...
var VectorObject = require('./Objects/VectorObject.js');
var Rectangle = require('./Objects/Rectangle.js');
var ImageObject = require('./Objects/ImageObject.js');
var Text = require('./Objects/Text.js');

var WarpdriveJS = function (width, height, backgroundColor, backgroundImage) {
    var self = this;
