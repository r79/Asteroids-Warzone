var WarpdriveJS = require('./Warpdrive/WarpdriveJS.js');

function Game(onUpdate) {
    var warpdrive = new WarpdriveJS(500, 500, '#555');

    function OverwrittenQuery() {
        var self = warpdrive.query;
        delete warpdrive.query;
    ...
    warpdrive.query = OverwrittenQuery(warpdrive);

    warpdrive.query.startCycle();
